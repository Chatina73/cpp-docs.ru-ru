...
| C5041 (уровень 4) | "*member-Name*": нестандартное определение для статических данных-члена constexpr не требуется и является устаревшим в c++ 17. <sup>15.2</sup>|
...
| C5204 (уровень 3) | Класс с виртуальными функциями имеет невиртуальный тривиальный деструктор. <sup>16.5</sup> |
| C5214 (уровень 4) | применение "*ключевого слова*" к операнду с постоянным квалифицированным типом является устаревшим в c++ 20 <sup>16,7</sup> |
| C5215 (уровень 4) | параметр функции "*Function-Parameter*" с постоянным квалифицированным типом является устаревшим в c++ 20 <sup>16,7</sup> |
| C5216 (уровень 4) | "*return-Type*" нерекомендуемый тип возвращаемого значения volatile в c++ 20 <sup>16,7</sup> |
| C5217 (уровень 4) | объявление структурированной привязки, включающее volatile, является устаревшим в C++ 20 <sup>16,7</sup> |
| C5219 (уровень 2) | неявное преобразование "*Type-1*" в "*тип-2*", возможна утрата данных <sup>16,7</sup> |
| C5220 (уровень 4) | "*член*": нестатические данные-член с временным квалифицированным типом больше не подразумевает, что<br/> созданные компилятором конструкторы копирования и перемещения и операторы присваивания копирования и перемещения не являются тривиальными <sup>16,7</sup> |
...
<sup>15,2</sup> это предупреждение доступно начиная с Visual Studio 2017 версии 15,2. \
...
<sup>16,5</sup> это предупреждение доступно начиная с Visual Studio 2019 версии 16,5. \
<sup>16,7</sup> это предупреждение доступно начиная с Visual Studio 2019 версии 16,7. \
